...
activities = {
    ...
    "Drama Club": {
        "description": "Acting workshops, script reading, and school productions",
    ...
    "Science Olympiad": {
        "description": "Prepare for regional science competitions with hands-on experiments and problem solving",
